	...
	char Alumnonuevo[20];
	 ...
	 switch (opcion)
	 {
	 	...
	 	switch(alumno)
		 {
			...
			printf("Seleccionaste a Kiernan\n");
		 	printf("Sus materias son: \n1) %s\n2) %s\n3) %s\n",Kiernan.Asignaturas[0].materia,Kiernan.Asignaturas[1].materia,Kiernan.Asignaturas[2].materia);
	    ...
	    case 2:
		 ...
		 case 1:
		 	...
		 	switch(opcion)
		 	{
		 		...
		 		printf("seleccionaste la materia %s \n",Sergio.Asignaturas[0].materia);	
		 			
		 		printf("Escribe el nombre de la nueva materia\n");
		 		
		 		scanf("%s",Materia0);
		 		strcpy(Sergio.Asignaturas[0].materia,Materia0);
			 ...
			 break;
		 		...
		 		printf("seleccionaste la materia %s \n",Sergio.Asignaturas[1].materia);	
		 			
		 		printf("Escribe el nombre de la nueva materia\n");
		 		
		 		scanf("%s",Materia1);
		 		strcpy(Sergio.Asignaturas[1].materia,Materia1);
			 ...
			 break;
		 		...
		 		printf("seleccionaste la materia %s \n",Sergio.Asignaturas[2].materia);	
		 			
		 		printf("Escribe el nombre de la nueva materia\n");
		 		
		 		scanf("%s",Materia2);
		 		strcpy(Sergio.Asignaturas[2].materia,Materia2);
		 ...
		 case 2:
		 	...
		 	switch(opcion)
		 	{
		 		...
		 		printf("seleccionaste la materia %s \n",Kiernan.Asignaturas[0].materia);	
		 			
		 		printf("Escribe el nombre de la nueva materia\n");
		 		
		 		scanf("%s",Materia0);
		 		strcpy(Kiernan.Asignaturas[0].materia,Materia0);
		 	...
		 	printf("seleccionaste la materia %s \n",Kiernan.Asignaturas[1].materia);	
		 			
		 		printf("Escribe el nombre de la nueva materia\n");
		 		
		 		scanf("%s",Materia1);
		 		strcpy(Kiernan.Asignaturas[1].materia,Materia1);	
			 //break de la opcion de modificacion materia 1 de kiernan
			 break;
			 
			 	case 3:
		 			
		 	printf("seleccionaste la materia %s \n",Kiernan.Asignaturas[2].materia);	
		 			
		 		printf("Escribe el nombre de la nueva materia\n");
		 		
		 		scanf("%s",Materia2);
		 		strcpy(Kiernan.Asignaturas[2].materia,Materia2);
	 ...
	 //break de caso 2 modificar materias de alumnos	
		...
		printf(" el alumno %s tiene estas materias\n",Alumnonuevo);
			printf("Sus materias son: \n1) %s\n2) %s\n3) %s\n",Nuevo.Asignaturas[0].materia,Nuevo.Asignaturas[1].materia,Nuevo.Asignaturas[2].materia);
